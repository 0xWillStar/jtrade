...
/**
 * FinishOrder operation
 *
 * @author 0xWill
 **/
@Component
@Slf4j
public class FinishOrderOperation extends AbstractTableOperation {

    @Getter
    private DataObject dataObject = DataObject.FINISH_ORDER;
