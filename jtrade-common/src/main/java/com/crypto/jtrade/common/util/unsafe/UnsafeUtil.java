...
public final class UnsafeUtil {
    ...
    /**
     * Returns a new {@link String} backed by the given {@code chars}. The char array should not be mutated any more
    ...
    /**
     * Gets the field with the given name within the class, or {@code null} if not found. If found, the field is made
     * accessible.
     */
